...
<h1 style="color:purple; font-family: chalkduster; font-size:150%;">**** Most Popular POIs ****</h1>
...
%>	
	...
	<label>Please enter the numbers of most popular POIs that you would like to view:&nbsp;</label> 
...
<%
	...
	session.setAttribute( "login", login);
	out.println("<pre>"+poi.listCat(num,connector.stmt)+"</pre>");
%>
	<BR><BR>
	<form method=get>	
	<input type="hidden" name="login" value="<%=session.getAttribute("login")%>">
