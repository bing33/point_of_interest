...
<h1 style="color:purple; font-family: chalkduster; font-size:130%;">**** Browse POIs By Address ****</h1>
</body>
<%
...
%>
	<BR><BR>
	<label style="color:purple; font-family: chalkduster; font-size:100%;">*** POI List, Please Enter City OR State to Filter ***</label>
<%
...
<%
		out.println("<pre>"+bp.listByCity(city, connector.stmt)+"</pre>");
	}
...
%>
		...
		<label style="color:purple; font-family: chalkduster; font-size:100%;">*** POI List Based On Your Selection ***</label>
<%
		out.println("<pre>"+bp.listByState(state, connector.stmt)+"</pre>");
	}
%>
	<form method=get>
	<input type="hidden" name="login" value="<%=session.getAttribute("login")%>">
