...
<h1 style="color:purple; font-family: chalkduster; font-size:150%;">**** Most Expensive POIs ****</h1>
...
%>	
	...
	<label>Please enter the numbers of most expensive POIs that you would like to view:&nbsp;</label> 
...
<%
	...
	session.setAttribute( "login", login);
	out.println("<pre>"+poi.listEx(num,connector.stmt)+"</pre>");
%>
	<BR><BR>
	<form method=get>	
	<input type="hidden" name="login" value="<%=session.getAttribute("login")%>">
