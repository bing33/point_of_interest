...
<h1 style="color:purple; font-family: chalkduster; font-size:120%;">**** Browse POIs By Price, Address, and Keyword ****</h1>
</body>
<%
...
%>
	...
	<BR><BR>
	<label style="color:purple; font-family: chalkduster; font-size:100%;">Please Enter Low Price, High Price, Keyword, and City to Filter ("Low To High" or "High To Low"): </label>
	<BR><BR>
	<label style="color:purple; font-family: chalkduster; font-size:100%;">Please Enter Low Price, High Price, Keyword, and State to Filter ("Low To High" or "High To Low"):</label>
	<BR><BR>
	<BR><BR>
...
<%
		out.println("<pre>"+bp.listKwCityPriceLE(kw, city, lowPrice, highPrice, connector.stmt)+"</pre>");
...
%>
		...
		<label style="color:purple; font-family: chalkduster; font-size:100%;">*** POI List Based On Your Selection ***</label>
<%
		out.println("<pre>"+bp.listKwCityPriceGE(kw, city,lowPrice, highPrice, connector.stmt)+"</pre>");
...
%>
		...
		<label style="color:purple; font-family: chalkduster; font-size:100%;">*** POI List Based On Your Selection ***</label>
<%
		out.println("<pre>"+bp.listKwStatePriceLE(kw, state, lowPrice, highPrice, connector.stmt)+"</pre>");
...
%>
		...
		<label style="color:purple; font-family: chalkduster; font-size:100%;">*** POI List Based On Your Selection ***</label>
<%
		out.println("<pre>"+bp.listKwStatePriceGE(kw, state, lowPrice, highPrice, connector.stmt)+"</pre>");
	}
%>
	<form method=get>
	<input type="hidden" name="login" value="<%=session.getAttribute("login")%>">
