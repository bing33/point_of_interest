...
<h1 style="color:purple; font-family: chalkduster; font-size:120%;">**** Browse POIs By Address, Keyword, and Category ****</h1>
</body>
<%
...
%>
	...
	<BR><BR>
	<label style="color:purple; font-family: chalkduster; font-size:100%;">Please Enter Keyword, Category, and City to Filter ("Low To High" or "High To Low"): </label>
	<BR><BR>
	<label style="color:purple; font-family: chalkduster; font-size:100%;">Please Enter Keyword, Category, and State to Filter ("Low To High" or "High To Low"):</label>
	<BR><BR>
	<BR><BR>
...
<%
		out.println("<pre>"+bp.listKwCateCity(kw, cate, city, connector.stmt)+"</pre>");
...
%>
		...
		<label style="color:purple; font-family: chalkduster; font-size:100%;">*** POI List Based On Your Selection ***</label>
<%
		out.println("<pre>"+bp.listKwCateState(kw, cate, state, connector.stmt)+"</pre>");
