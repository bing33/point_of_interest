...
<h1 style="color:purple; font-family: chalkduster; font-size:130%;">**** Your Selected POI's Rated Feedbacks ****</h1>
</body>
<%
	...
	out.println(fb.displayTitle(poiID, connector.stmt));
	out.println("<pre>"+fb.displayTopFeedbacks(poiID, num, connector.stmt)+"</pre>");
%>
