...
<h1 style="color:purple; font-family: chalkduster; font-size:130%;">**** Adding Your Feedback For A POI (Scroll Down To Bottom of Page To Go To Different Pages ****</h1>
</body>
<%
...
%>	
	<form method=get>
	<label>Please select the POI to provide your feedback(enter a POI ID from above list):&nbsp;</label> 
...
<%
	...
	if(request.getParameter("s") != null)
	{
		if(fb.feedbackExists(login, poiID, connector.stmt))
			out.println("You have already given feedbacks for this POI!");
		else
			response.sendRedirect("provide.jsp?poiID=" + poiID+"&login="+login);
	}
