...
<h1 style="color:purple; font-family: chalkduster; font-size:120%;">**** Browse POIs By Address and Keyword ****</h1>
</body>
<%
...
%>
	...
	<BR><BR>
	<label style="color:purple; font-family: chalkduster; font-size:100%;">Please Enter Keyword and City to Filter: </label>
	<BR><BR>
	<label style="color:purple; font-family: chalkduster; font-size:100%;">Please Enter Keyword and State to Filter: </label>
	<BR><BR>
...
<%
		out.println("<pre>"+bp.listByKwCity(kw, city, connector.stmt)+"</pre>");
...
%>
		...
		<label style="color:purple; font-family: chalkduster; font-size:100%;">*** POI List Based On Your Selection ***</label>
<%
		out.println("<pre>"+bp.listByKwState(kw, state, connector.stmt)+"</pre>");
