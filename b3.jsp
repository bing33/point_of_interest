...
<h1 style="color:purple; font-family: chalkduster; font-size:130%;">**** Browse POIs By Keyword ****</h1>
</body>
<%
...
%>
	<BR><BR>
	<label style="color:purple; font-family: chalkduster; font-size:100%;">*** POI List, Please Enter A Keyword to Filter ***</label>
<%
...
<%
		out.println("<pre>"+bp.listByKeyword(kw,connector.stmt)+"</pre>");
	}
%>
	<form method=get>
	<input type="hidden" name="login" value="<%=session.getAttribute("login")%>">
