...
<h1 style="color:purple; font-family: chalkduster; font-size:130%;">**** Browse POIs By Category ****</h1>
</body>
<%
...
%>
	<BR><BR>
	<label style="color:purple; font-family: chalkduster; font-size:100%;">*** POI List, Please Enter A Category to Filter ***</label>
<%
...
<%
		out.println("<pre>"+bp.listByCate(cate,connector.stmt)+"</pre>");
