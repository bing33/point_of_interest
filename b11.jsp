...
<h1 style="color:purple; font-family: chalkduster; font-size:120%;">**** Browse POIs By Price, Keyword, and Category ****</h1>
</body>
<%
...
%>
	<BR><BR>
	<label style="color:purple; font-family: chalkduster; font-size:100%;">Please Enter Low Price, High Price, Keyword, and Category to Filter ("Low To High" or "High To Low"): </label>
	<BR><BR>
...
<%
		out.println("<pre>"+bp.listKwCatePriceLE(kw, cate, lowPrice, highPrice, connector.stmt)+"</pre>");
...
%>
		...
		<label style="color:purple; font-family: chalkduster; font-size:100%;">*** POI List Based On Your Selection ***</label>
<%
		out.println("<pre>"+bp.listKwCatePriceGE(kw, cate, lowPrice, highPrice, connector.stmt)+"</pre>");
