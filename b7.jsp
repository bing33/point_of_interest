...
<h1 style="color:purple; font-family: chalkduster; font-size:120%;">**** Browse POIs By Price, Address, Keyword, and Category ****</h1>
</body>
<%
...
%>
	...
	<BR><BR>
	<label style="color:purple; font-family: chalkduster; font-size:100%;">Please Enter Low Price, High Price, Keyword, Category, and City to Filter ("Low To High" or "High To Low"): </label>
	<BR><BR>
	<label style="color:purple; font-family: chalkduster; font-size:100%;">Please Enter Low Price, High Price, Keyword, Category, and State to Filter ("Low To High" or "High To Low"):</label>
	<BR><BR>
	<BR><BR>
...
<%
		out.println("<pre>"+bp.listKwCateCityPriceLE(kw, cate, city, lowPrice, highPrice, connector.stmt)+"</pre>");
...
%>
		...
		<label style="color:purple; font-family: chalkduster; font-size:100%;">*** POI List Based On Your Selection ***</label>
<%
		out.println("<pre>"+bp.listKwCateCityPriceGE(kw, cate, city,lowPrice, highPrice, connector.stmt)+"</pre>");
...
%>
		...
		<label style="color:purple; font-family: chalkduster; font-size:100%;">*** POI List Based On Your Selection ***</label>
<%
		out.println("<pre>"+bp.listKwCateStatePriceLE(kw, cate, state, lowPrice, highPrice, connector.stmt)+"</pre>");
...
%>
		...
		<label style="color:purple; font-family: chalkduster; font-size:100%;">*** POI List Based On Your Selection ***</label>
<%
		out.println("<pre>"+bp.listKwCateStatePriceGE(kw, cate, state, lowPrice, highPrice, connector.stmt)+"</pre>");
	}
%>
	<form method=get>
	<input type="hidden" name="login" value="<%=session.getAttribute("login")%>">
